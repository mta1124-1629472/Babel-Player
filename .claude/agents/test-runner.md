...
Steps:
1. Run: `dotnet test "$CLAUDE_PROJECT_DIR/Babel-Player.sln" --filter "Category!=Integration&Category!=RequiresPython&Category!=RequiresFfmpeg&Category!=RequiresExternalTranslation" --no-build 2>&1 || dotnet test "$CLAUDE_PROJECT_DIR/Babel-Player.sln" --filter "Category!=Integration&Category!=RequiresPython&Category!=RequiresFfmpeg&Category!=RequiresExternalTranslation" 2>&1`
